...
# Load project
  eval vsim -novopt -quiet -nocoverage +notimingchecks +nowarnTSCALE -sva -G/top/test/number_of_tranzactions=$2 -G/top/test/RND_CASE=$3  -G/top/test/seed=$4 -G/top/test/testname=$5 top
